...
The goal of btt22 is to help you build the [**ussie**](https://github.com/rstudio-conf-2022/ussie) package during the [Building Tidy Tools 2022](https://github.com/rstudio-conf-2022/build-tidy-tools) workshop.
...
There are two big purposes for this package:
 ...
 - you can use the functions from this package to import code:
   - `btt_state()`: list all the available states. A state has an identifier like `"2.1.1"`: day `2`, session `1`, task `1`. This identifier corresponds to a [branch in the {ussie} repository](https://github.com/rstudio-conf-2022/ussie/branches).
   - `btt_get(state)`: 
